...
/// below can be revamped or retired
...
//         else if( is_dir(ASM_EXT_ROOT.$ExtLoader) && is_file(ASM_EXT_ROOT.$ExtLoader.DIRECTORY_SEPARATOR.'Load.inc') )
//             require(ASM_EXT_ROOT.$ExtLoader.DIRECTORY_SEPARATOR.'Load.inc');
//         else
//             throw new Exception("Extension '$ExtLoader' not found.");
//     }
// }
