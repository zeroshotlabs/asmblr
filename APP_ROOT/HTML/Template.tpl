...
<div class="tab-content">
    <div class="tab-pane" id="routine_tab">
        <textarea id="template_routine" name="Routine" data-method="template_set_routine" data-mode="text/x-php"><?=$this(\fw\Struct::Get(0,$T['Routine']))?></textarea>
        <div>
    ...
    <div class="tab-pane" id="body_tab">
        <textarea id="template_body" name="Body" data-method="template_set_body" data-mode="application/x-httpd-php"><?=$this($T['Body'])?></textarea>
        <div>
